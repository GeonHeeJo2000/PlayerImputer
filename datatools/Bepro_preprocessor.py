...
class NewPreprocessor:
    ...
    def _load_event_data(self):
        ...
        first_event_paths = [file for file in os.listdir(self.game_path) if file.endswith("1st Half.json")]
        second_event_paths = [file for file in os.listdir(self.game_path) if file.endswith("2nd Half.json")]

        first_data = load_single_json(os.path.join(self.game_path, first_event_paths[0]))['data']
        second_data = load_single_json(os.path.join(self.game_path, second_event_paths[0]))['data']
